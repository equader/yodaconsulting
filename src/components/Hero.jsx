...
<section class="bg-cover bg-no-repeat bg-white bg-blend-multiply">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base text-center text-emerald bg-propsagreen hover:bg-emerald hover:text-propsagreen focus:ring-4 rounded-lg">
                Get in touch
