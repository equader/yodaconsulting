...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
        ...
        <div class="lg:mx-auto text-left">
            ...
            <ul class="text-sm  transition-all duration-500">
                <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">anup.mahimkar@yodaconsulting.com</a></li>
